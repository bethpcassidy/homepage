...
var CAccordionCollapse = (0, import_react.forwardRef)(function(_a, ref) {
  ...
  return import_react.default.createElement(CCollapse, __assign({ className: "accordion-collapse" }, props, { ref }), children);
});
...
var CDropdown = (0, import_react.forwardRef)(function(_a, ref) {
  ...
  var DropdownContent = function() {
    return variant === "input-group" ? import_react.default.createElement(import_react.default.Fragment, null, children) : import_react.default.createElement(Component, __assign({ className: classNames(variant === "nav-item" ? "nav-item dropdown" : variant, {
  ...
  return import_react.default.createElement(CDropdownContext.Provider, { value: contextValues }, popper2 ? import_react.default.createElement(
    Manager,
    null,
    import_react.default.createElement(DropdownContent, null)
  ) : import_react.default.createElement(DropdownContent, null));
});
...
var CDropdownMenu = function(_a) {
  ...
  var dropdownMenuComponent = function(style, ref) {
    return import_react.default.createElement(Component, __assign({ className: classNames("dropdown-menu", {
      "dropdown-menu-dark": dark,
      show: visible
    }, alignment && alignmentClassNames(alignment), className), ref, style, role: "menu", "aria-hidden": !visible }, !popper2 && { "data-coreui-popper": "static" }, rest), Component === "ul" ? import_react.default.Children.map(children, function(child, index) {
      if (import_react.default.isValidElement(child)) {
...
var CDropdownToggle = function(_a) {
  ...
  var Toggler = function(ref) {
    if (custom && import_react.default.isValidElement(children)) {
      return import_react.default.createElement(import_react.default.Fragment, null, import_react.default.cloneElement(children, __assign(__assign({ "aria-expanded": visible }, !rest.disabled && __assign({}, triggers)), { ref: useForkedRef(ref, dropdownToggleRef) })));
    }
    if (variant === "nav-item") {
      return import_react.default.createElement("a", __assign({ href: "#" }, togglerProps, { ref: useForkedRef(ref, dropdownToggleRef) }), children);
    }
    return import_react.default.createElement(
      CButton,
...
COffcanvas.propTypes = {
  ...
  onHide: propTypesExports.func,
  onShow: propTypesExports.func,
  placement: propTypesExports.oneOf(["start", "end", "top", "bottom"]).isRequired,
  portal: propTypesExports.bool,
...
var CProgressBar = (0, import_react.forwardRef)(function(_a, ref) {
  ...
  return import_react.default.createElement("div", __assign({ className: classNames("progress-bar", (_b = {}, _b["bg-".concat(color)] = color, _b["progress-bar-".concat(variant)] = variant, _b["progress-bar-animated"] = animated, _b), className), role: "progressbar", style: { width: "".concat(value, "%") }, "aria-valuenow": value, "aria-valuemin": 0, "aria-valuemax": 100 }, rest, { ref }), children);
});
...
var CProgress = (0, import_react.forwardRef)(function(_a, ref) {
  ...
  return import_react.default.createElement("div", { className: classNames("progress", {
    "progress-thin": thin,
    "progress-white": white
  }, className), style: height ? { height: "".concat(height, "px") } : {}, ref }, value ? import_react.default.createElement(CProgressBar, __assign({ value }, rest), children) : children);
});
CProgress.propTypes = {
  children: propTypesExports.node,
  className: propTypesExports.string,
...
var CPopover = function(_a) {
  var children = _a.children, className = _a.className, content = _a.content, _b = _a.offset, offset2 = _b === void 0 ? [0, 8] : _b, onHide = _a.onHide, onShow = _a.onShow, _c = _a.placement, placement = _c === void 0 ? "top" : _c, title = _a.title, _d = _a.trigger, trigger = _d === void 0 ? "click" : _d, visible = _a.visible, rest = __rest(_a, ["children", "className", "content", "offset", "onHide", "onShow", "placement", "title", "trigger", "visible"]);
  ...
  return import_react.default.createElement(
    import_react.default.Fragment,
    null,
    import_react.default.cloneElement(children, __assign(__assign(__assign({ ref: setReferenceElement }, (trigger === "click" || trigger.includes("click")) && {
      onClick: function() {
    ...
    typeof window !== "undefined" && (0, import_react_dom.createPortal)(import_react.default.createElement(Transition$1, { in: _visible, mountOnEnter: true, nodeRef: popoverRef, onEnter: onShow, onExit: onHide, timeout: {
      ...
      return import_react.default.createElement(
        "div",
        __assign({ className: classNames("popover", "bs-popover-".concat(placement.replace("left", "start").replace("right", "end")), "fade", {
          show: state === "entered"
...
var CSpinner = (0, import_react.forwardRef)(function(_a, ref) {
  ...
  return import_react.default.createElement(
    Component,
    __assign({ className: classNames("spinner-".concat(variant), "text-".concat(color), size && "spinner-".concat(variant, "-").concat(size), className), role: "status" }, rest, { ref }),
...
var CTooltip = function(_a) {
  var children = _a.children, className = _a.className, content = _a.content, _b = _a.offset, offset2 = _b === void 0 ? [0, 0] : _b, onHide = _a.onHide, onShow = _a.onShow, _c = _a.placement, placement = _c === void 0 ? "top" : _c, _d = _a.trigger, trigger = _d === void 0 ? "hover" : _d, visible = _a.visible, rest = __rest(_a, ["children", "className", "content", "offset", "onHide", "onShow", "placement", "trigger", "visible"]);
  ...
  return import_react.default.createElement(
    ...
    typeof window !== "undefined" && (0, import_react_dom.createPortal)(import_react.default.createElement(Transition$1, { in: _visible, mountOnEnter: true, nodeRef: tooltipRef, onEnter: onShow, onExit: onHide, timeout: {
      enter: 0,
      exit: 200
    }, unmountOnExit: true }, function(state) {
      return import_react.default.createElement(
        "div",
        __assign({ className: classNames("tooltip", "bs-popover-".concat(placement.replace("left", "start").replace("right", "end")), "fade", {
          show: state === "entered"
        }, className), ref: setPopperElement, role: "tooltip", style: styles.popper }, attributes.popper, rest),
